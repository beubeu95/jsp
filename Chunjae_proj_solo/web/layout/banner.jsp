	...
	<figure class="vs">
		<ul class="img_box">
			<li class="item1 active"><input type="radio" name="vs_ra"
				...
				<h2 class="vs_tit">
					교육에 대한 끊임없는 도전<br> <strong>행복한 내일을 함께 합니다</strong>
				</h2></li>
			<li class="item2"><input type="radio" name="vs_ra" id="vs_ra2"
				class="vs_ra">
				<div class="bg_box"></div>
				<h2 class="vs_tit">
					“나눔의 힘! 실천의 힘!”<br> <strong>작은 따뜻함으로 세상을 <br>바꿉니다
					</strong>
				</h2></li>
		</ul>
		<ul class="btn_box">
		...
		<div class="page_wrap">
			...
			<ul class="pic_lst">
				<li class="item1"><a href="">
						...
						<h3 class="pic_tit">제목</h3> <span class="pic_arrow"></span>
				</a></li>
				...
				<ul class="card_lst">
					<li class="item1">
						...
						<ul class="cate_lst">
							...
							<li><a href="">
									<p class="bd_content">천재교과서, 스마트해법-밀크T 온·오프라인 결합 상품 더블케어
										천재패스 출시</p>
									<p class="bd_date">2023-07-17</p>
							</a></li>
						</ul>
					...
					<li class="item2"><a href="">
							...
							<p class="thumb_tit">썸네일제목2 썸네일제목2 썸네일제목2 썸네일제목2 썸네일제목2
								썸네일제목2 썸네일제목2썸네일제목2 썸네일제목2 썸네일제목2 썸네일제목2썸네일제목2썸네일제목2 썸네일제목2</p>
							<div class="ico_box">
