...
INSERT INTO `board` (`bno`, `title`, `content`, `author`, `resdate`, `cnt`) VALUES
	(1, '더미글1', '여기는 더미글1입니다', 'admin', '2023-07-28 01:09:30', 0),
	(2, '더미글2', '여기는 더미글2입니다', 'admin', '2023-07-28 01:10:11', 0),
	(3, '더미글3', '여기는 더미글3입니다', 'admin', '2023-07-28 01:10:22', 0),
	(4, '더미글4', '여기는 더미글4입니다', 'admin', '2023-07-28 01:10:36', 0),
	(5, '더미글5', '여기는 더미글5입니다', 'lee', '2023-07-28 01:10:58', 0),
	(6, '더미글6', '여기는 더미글6입니다', 'admin', '2023-07-28 01:11:13', 0),
	(7, '더미글7', '여기는 더미글7입니다', 'admin', '2023-07-28 01:11:30', 1),
	(8, '더미글8', '여기는 더미글8입니다', 'lee', '2023-07-28 01:19:37', 0),
	(9, '더미글9', '여기는 더미글9입니다', 'shin', '2023-07-28 01:51:08', 0);
...
INSERT INTO `board2` (`bno`, `title`, `content`, `author`, `resdate`, `cnt`) VALUES
	...
	(5, '더미글5', '여기는 더미글5입니다', 'lee', '2023-07-28 01:10:58', 0),
	(6, '더미글6', '여기는 더미글6입니다', 'admin', '2023-07-28 01:11:13', 0),
	(7, '더미글7', '여기는 더미글7입니다', 'admin', '2023-07-28 01:11:30', 0),
	(8, '더미글8', '여기는 더미글8입니다', 'lee', '2023-07-28 01:19:37', 0),
	(9, '더미글9', '여기는 더미글9입니다', 'shin', '2023-07-28 01:51:08', 0);
...
INSERT INTO `member` (`id`, `pw`, `NAME`, `email`, `tel`, `regdate`, `POINT`) VALUES
	('admin', '1234', '관리자', 'admin@edu.com', '010-1004-1004', '2023-07-28 00:48:43', 0),
	('choi', '1313', '김보경', 'chio@edu.com', '010-1313-1004', '2023-07-28 00:51:43', 0),
	('kim', '1111', '김현경', 'kim@edu.com', '010-1111-1004', '2023-07-28 00:51:43', 0),
	('lee', '2222', '박진권', 'lee@edu.com', '010-2222-1004', '2023-07-28 00:51:43', 0),
	('park', '1212', '신예은', 'park@edu.com', '010-1212-1004', '2023-07-28 00:51:43', 0);

-- 테이블 edu.product 구조 내보내기
...
-- 테이블 데이터 edu.product:~4 rows (대략적) 내보내기
INSERT INTO `product` (`gcode`, `gname`, `gcate`, `gprice`, `gqty`, `regdate`) VALUES
	(1, '중국어', '교육', 25000, 0, '2023-07-28 04:52:18'),
	(2, '일본어', '교육', 32000, 0, '2023-07-28 05:05:21'),
	(3, '영어', '교육', 27000, 0, '2023-07-28 05:06:32'),
	(4, '스페인어', '교육', 29000, 0, '2023-07-28 05:07:34');
